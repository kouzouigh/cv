...
\newcommand{\forkme}{
    \begin{tikzpicture}[remember picture, overlay]
        ...
        \node[shift={(0.8em, 1.7em)}, text centered, minimum width=50em, minimum height=3.0em, text=forkmefg](fmogh) at (0pt, -30pt) { \fontfamily{phv}\selectfont\bfseries \href{https://github.com/danieldietrich/cv}{\rotatebox{45}{\color{white}{Fork me on GitHub}}} };
    \end{tikzpicture}
}
...
\begin{tabular}{rl}
    ...
    \textsc{Socials:}   & \faHome{} \href{https://kouzouigh.github.com/blog}{blog} 
...
\begin{tabular}{p{0.9\textwidth}}
    Kamel is a highly motivated Senior Software Engineer, with 13+ years experience\\\\

    Kamel is intrinsically by clean and robust code.\\\\

    TODO

    Interests: \sotag{functional-programming} \sotag{oop} \sotag{java} \sotag{ci/cd} \sotag{scala} \sotag{microservices} \sotag{architecture}
\end{tabular}
